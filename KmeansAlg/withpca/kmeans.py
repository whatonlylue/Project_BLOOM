...
# Create tensor_indices to track origin of data
#tensor_indices = []
...
num_clusters = 11  # number of clusters, adjust as needed
kmeans = KMeans(n_clusters=num_clusters, random_state=42)
cluster_labels = kmeans.fit_predict(reduced_data)

# Plot clusters
plt.scatter(reduced_data[:, 0], reduced_data[:, 1], c=cluster_labels, cmap='tab20', alpha=0.7)
